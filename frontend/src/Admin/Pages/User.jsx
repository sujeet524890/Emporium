...
const User = () => {
  ...
  const { user , deletuser} = useContext(AppContext);
        ...
        <div className="md:hidden space-y-2">
          {user.map((item, index) => (
            ...
            >
              ...
              <button className="mt-3 w-full bg-red-500 text-white py-2 rounded"onClick={(e)=>{deletuser(item._id)
                e.preventDefault()}
              }>
                Delete User
              </button>
